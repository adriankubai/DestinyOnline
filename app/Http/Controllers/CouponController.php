...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $input_data = new Coupon();
        $input_data->coupon_code = request('coupon_code');
        $input_data->amount = request('amount');
        $input_data->amount_type = request('amount_type');
        $input_data->expiry_date = request('expiry_date');
        ...
        $input_data->save();
        return redirect()->route('coupon_index')->with('message',' Coupon created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('coupon_index')->with('message','Updated Coupon Successfully!');
    }
