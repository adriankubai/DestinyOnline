...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('products_index')}}">Products</a> <a href="#" class="current">Add Attribute</a> </div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <ul class="recent-posts">
                            ...
                            <li>
                                <form action="{{route('product_atrr_store')}}" method="post" role="form">
