...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('categories_index')}}" class="current">Categories</a></div>
                    ...
                    @foreach($categories as $category)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="text-align: center;">
                                <a href="{{route('category_edit',$category->id)}}" class="btn btn-primary btn-mini">Edit</a>
