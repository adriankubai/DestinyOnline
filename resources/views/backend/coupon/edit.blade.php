...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('coupon_index')}}">Coupons</a> <a href="#" class="current">Edit Coupon</a> </div>
    <div class="container-fluid">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{route('coupon_update',$edit_coupons->id)}}" method="post" class="form-horizontal">
